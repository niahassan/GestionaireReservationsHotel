...
namespace HotelManager.Gui
{
    public partial class Rooms : BaseFrameWithSearch<Room>
    {
        ...
        protected override void BaseFrame_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            gridView.Columns.Add(CreateColumn("Number", "Numéro de chambre"));
            gridView.Columns.Add(CreateColumn("Status", "Etat"));
            gridView.Columns.Add(CreateColumn("Reservations", "Réservations"));
        ...
        protected override ContextMenu BuildMenu(int index)
        {
            ...
            editReservations.Header = "Modifier réservations";
